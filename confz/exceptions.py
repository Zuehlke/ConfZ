...
class ConfZEnvException(ConfZException):
    """Exception which is raised if something went wrong while reading environment
    variables.
    *Placeholder, this exception is not in use right now.*"""


class ConfZCLArgException(ConfZException):
    """Exception which is raised if something went wrong while reading command line
    arguments.
    *Placeholder, this exception is not in use right now.*"""
