...
class ConfZFileSource(ConfZSource):
    ...
    name must follow after a whitespace, an equal sign between argument and value is not supported at the moment."""
...
class ConfZCLArgSource(ConfZSource):
    ...
    Between argument and value must be a space, an equal sign is not supported at the moment."""
    prefix: Optional[str] = None
